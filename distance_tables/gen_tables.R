...
range_05_samp <- process_dist(dist_rat_05, dist_samp_pca_05, dist_samp_ss_05, dist_samp_fourier_05)
...
range_1_samp <- process_dist(dist_rat_1, dist_samp_pca_1, dist_samp_ss_1, dist_samp_fourier_1)
...
attr(dist_nngp_05, "m.vec") <- attr(dist_rat_05, "m.vec")
attr(dist_nngp_05, "nu.vec") <- attr(dist_rat_05, "nu.vec")
